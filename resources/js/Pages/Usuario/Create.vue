                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            placeholder="Nombre"
                        />
                        <div v-if="form.errors.nombre" class="text-danger">
                            {{ form.errors.nombre }}
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        />
                        <div v-if="form.errors.telefono" class="text-danger">
                    ...
                    <div class="mb-3">
                        ...
                        <div v-if="form.errors.id_rol" class="text-danger">
                            {{ form.errors.id_rol }}
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div
                            v-if="form.errors.id_departamento"
                            class="text-danger"
                        >
                            {{ form.errors.id_departamento }}
                        </div>
                    </div>
                </div>
